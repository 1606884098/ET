...
public class NIOServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        serverSocketChannel.configureBlocking(false); // 设置为非阻塞模式  默认是阻塞
        ...
        while (true) {
            ...
            if (socketChannel != null) {
                ...
                try {
                    ...
                    while (socketChannel.isOpen() && socketChannel.read(requestBuffer) != -1) {//这里还是阻塞的，要等连接上的数据发来
